...
program3 = {
    ...
    'NV': '/home/hongzheng/Codes/CLionProjects/IOE-SORW/build/dual-bucket/trade-off/map-get/static-log2/OL'
}
...
# 为了对比FR的性能变差是否是由于也on-demand加载了current block导致。下面这个是仅有ancillary block on-demand loading的版本
program5 = '/home/hongzheng/Codes/CLionProjects/IOE-SORW/build/dual-bucket/trade-off/map-get/static-log2/OL'
...
logRootPath = '/home/hongzheng/Codes/CLionProjects/IOE-SORW/log/paper/IO_reducing/FR-ADD/OLDB'
